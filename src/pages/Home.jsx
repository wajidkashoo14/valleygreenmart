...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Full refund if not fresh",
    color: "text-amber-600 bg-amber-100",
  },
  {
    icon: <Award size={18} />,
    title: "GI Certified",
    desc: "Authentic Kashmir origin",
  ...
  const specials = PRODUCTS.filter(
    (p) =>
      [
        ...
        "Kashmiri Pickles",
        "Dry Fruit Basket",
      ].includes(p.category) && !p.panIndia
  );
    ...
    <PageWrapper>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 lg:py-16">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                Premium organic vegetables, fruits, dry fruits, saffron and
                specialty Kashmiri products — sourced directly from local
                farmers.
              </motion.p>
            ...
            >
              {[
                ...
                >
                  ...
                  <div className="font-display text-xl sm:text-2xl font-bold text-white leading-none">
                    {val}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
            {FEATURES.map((f, i) => (
              ...
              >
                <div
                  className={`w-8 h-8 sm:w-10 sm:h-10 rounded-xl ${f.color} flex items-center justify-center flex-shrink-0`}
                >
                  {f.icon}
                </div>
                <div className="min-w-0">
                  <div className="font-semibold text-xs sm:text-sm text-green-900 leading-tight">
                    {f.title}
                  </div>
                  <div className="text-[10px] sm:text-xs text-green-500 truncate">
                    {f.desc}
                  </div>
                </div>
              </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className="flex items-end justify-between mb-5 sm:mb-8">
          <div>
            <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-green-500 mb-0.5 sm:mb-1">
              Browse By
            </p>
            <h2 className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-green-900">
              Shop Categories
            </h2>
          </div>
          <button
          ...
          {CATEGORIES.map((cat, i) => (
            <motion.button
              ...
              onClick={() =>
                cat.key === "all"
                  ...
                  : navigate(
                      `/products?subcategory=${encodeURIComponent(cat.key)}`
                    )
              }
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 text-white text-center">
                ...
                <div className="text-[9px] sm:text-[10px] text-white/60 hidden sm:block">
                  {cat.count} items
                </div>
              </div>
            </motion.button>
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-green-950/92 via-green-900/70 to-transparent flex items-center">
            <div className="px-5 sm:px-8 lg:px-12 max-w-lg">
              ...
              <p className="text-green-300 text-xs sm:text-sm sm:text-base mb-3 sm:mb-5 hidden xs:block">
                Hand-picked from the golden fields of Pampore. ISO certified,
                lab-tested purity.
              </p>
              <button
                onClick={() => navigate("/products?category=Saffron")}
          ...
          {[
            {
              ...
              city: "Delhi",
              star: 5,
              text: "The Kashmir saffron is genuinely the finest I've ever tasted. Arrived in perfect packaging, completely authentic.",
              img: "https://api.dicebear.com/7.x/personas/svg?seed=Arjun&backgroundColor=d1ffe4",
            },
            {
              name: "Priya Nair",
              city: "Bangalore",
              star: 5,
              text: "Mamra almonds are incredible — nothing like regular almonds. The whole dry fruit collection is worth every rupee.",
              img: "https://api.dicebear.com/7.x/personas/svg?seed=Priya&backgroundColor=ffd1e4",
            },
            {
              name: "Farida Khan",
              city: "Mumbai",
              star: 5,
              text: "Ordered the wedding gift box for Eid — absolutely stunning packaging and the quality blew everyone away!",
              img: "https://api.dicebear.com/7.x/personas/svg?seed=Farida&backgroundColor=d1e4ff",
            },
          ].map((t, i) => (
            <motion.div
              key={t.name}
