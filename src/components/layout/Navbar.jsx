...
export default function Navbar() {
  ...
  const currentCol =
    MEGA_MENU.find((c) => c.title === activeCol) ?? MEGA_MENU[0];
      ...
      <div ref={headerRef} className="sticky top-0 z-50">
        ...
        <div className="bg-green-900 text-white text-xs py-2 text-center tracking-wide select-none hidden sm:block">
          ...
          <span className="text-green-300 font-semibold">
            Sourced directly from Kashmir's farms
          </span>
              ...
              <div className="relative">
                {isLoggedIn && user ? (
                  ...
                  >
                    ...
                    <ChevronDown
                      size={12}
                      className={`text-green-400 transition-transform duration-200 hidden sm:block ${
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-green-100 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15),0_4px_16px_rgba(0,0,0,0.06)]">
                <div className="flex" style={{ minHeight: 340 }}>
                  ...
                  <div className="flex-1 p-6 overflow-hidden">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        {currentCol.promo && (
                          <div
                            className={`mt-4 bg-gradient-to-r ${currentCol.color} border border-green-200/50 rounded-xl px-4 py-2.5 flex items-center gap-2`}
                          >
                            <Sparkles
                              size={13}
                  ...
                  <div className="w-[170px] flex-shrink-0 bg-green-900 border-l border-green-800 px-5 py-5 flex flex-col gap-5">
                    <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-green-400">
                      Why Us
                    </p>
                    {[
                      {
                    ...
                    <div className="mt-auto border-t border-green-800 pt-4">
                      <p className="text-[9px] uppercase tracking-wider text-green-500 mb-2 font-bold">
                        Top Pick
                      </p>
                      <button
                        onClick={() => {
                      ...
                      >
                        <div className="w-full h-20 rounded-xl overflow-hidden mb-2">
                          <img
                            src="https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=300&q=85&auto=format&fit=crop"
                            alt="Saffron"
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 py-4 border-b border-green-100 bg-green-50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-display font-bold text-[14px] text-green-900">
                    Valley Green Mart
                  </span>
                </div>
                <button
                  onClick={() => setMobileOpen(false)}
                  className="w-8 h-8 rounded-full hover:bg-green-100 flex items-center justify-center text-green-700 transition-colors"
                >
                  <X size={16} />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4">
                ...
                <div className="space-y-0.5 mb-5">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-green-400 px-2 mb-2">
                    Navigation
                  </p>
                  ...
                  <MobileLink to="/cart" onClick={() => setMobileOpen(false)}>
                    🛒 Cart
                    {totalItems > 0 && (
                      <span className="ml-auto bg-green-100 text-green-700 text-[10px] px-2 py-0.5 rounded-full font-bold">
                        {totalItems}
                      </span>
                    )}
                  </MobileLink>
                ...
                {/* Categories */}
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-green-400 px-2 mb-3">
                    Browse Categories
                  </p>
                  {MEGA_MENU.map((col) => (
                      ...
                      <div className="grid grid-cols-1 gap-1">
                        {col.items.map((item) => (
                          ...
                          >
                            ...
                            <div>
                              <div className="text-[13px] font-semibold text-green-900 leading-tight">
                                {item.label}
                              </div>
                            ...
                            <ArrowRight
                              size={13}
                              className="ml-auto text-green-300 group-hover:text-green-600 transition-colors"
                            />
                          </button>
                        ))}
                      </div>
