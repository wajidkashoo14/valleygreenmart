...
export default function Navbar() {
  ...
  const goToCategory = (cat) => {
    // All pan-india variants route to panIndia=true
  ...
  return (
    <>
      ...
      <div ref={headerRef} className="sticky top-0 z-50">
        ...
        {/* Announcement bar */}
        <div className="bg-green-900 text-white text-[10px] sm:text-xs py-1.5 sm:py-2 text-center tracking-wide select-none hidden xs:block">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <button
                            onClick={() => {
                              navigate(currentCol.panIndia ? '/products?panIndia=true' : `/products?subcategory=${encodeURIComponent(currentCol.title)}`)
                              setMegaOpen(false)
                            }}
